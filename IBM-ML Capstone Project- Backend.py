...
def load_ratings():
    return pd.read_csv("C:\\Users\\ASUS\\Documents\\0- UT PGP AIML\\IBM-ML\\Capstone Project Course-Recommender-System v2\\ratings.csv")


def load_course_sims():
    return pd.read_csv("C:\\Users\\ASUS\\Documents\\0- UT PGP AIML\\IBM-ML\\Capstone Project Course-Recommender-System v2\\sim.csv")


def load_courses():
    df = pd.read_csv("C:\\Users\\ASUS\\Documents\\0- UT PGP AIML\\IBM-ML\\Capstone Project Course-Recommender-System v2\\course_processed.csv")
    df['TITLE'] = df['TITLE'].str.title()
    return df


def load_bow():
    return pd.read_csv("C:\\Users\\ASUS\\Documents\\0- UT PGP AIML\\IBM-ML\\Capstone Project Course-Recommender-System v2\\courses_bows.csv")


def load_profiles():
    return pd.read_csv("C:\\Users\\ASUS\\Documents\\0- UT PGP AIML\\IBM-ML\\Capstone Project Course-Recommender-System v2\\user_profile.csv")


def load_genres():
    return pd.read_csv("C:\\Users\\ASUS\\Documents\\0- UT PGP AIML\\IBM-ML\\Capstone Project Course-Recommender-System v2\\course_genre.csv")

def load_user_embeddings():
    return pd.read_csv("C:\\Users\\ASUS\\Documents\\0- UT PGP AIML\\IBM-ML\\Capstone Project Course-Recommender-System v2\\user_embeddings.csv")

def load_course_embeddings():
    return pd.read_csv("C:\\Users\\ASUS\\Documents\\0- UT PGP AIML\\IBM-ML\\Capstone Project Course-Recommender-System v2\\course_embeddings.csv")
